...
import net.enia.egoz.calendar.model.ModelMonth;
import net.enia.egoz.calendar.utils.CalendarCellListener;
import net.enia.egoz.calendar.utils.CalendarEventCellRender;
import net.enia.egoz.calendar.utils.CalendarSelectedListener;
import net.enia.egoz.calendar.utils.DefaultCalendarEventCellRender;
...
public class Calendar extends JPanel
{
    ...
    private void init()
    {
        putClientProperty(FlatClientProperties.STYLE, "background:if($Calendar.background,$Calendar.background,$Panel.background)");
        ...
        panelHeader.addEventButtonNow((ActionEvent e) -> now());
        panelHeader.showDate(panelDay.getMonthYear());
