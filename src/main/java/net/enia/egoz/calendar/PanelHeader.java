...
public class PanelHeader extends JPanel
{
    ...
    private void init()
    {
        putClientProperty(FlatClientProperties.STYLE, "border:5,5,5,5;"
        ...
        buttonDate.putClientProperty(FlatClientProperties.STYLE, "background:if($Calendar.background,$Calendar.background,$Panel.background);"
            + "borderWidth:0;"
            + "focusWidth:0;"
            + "arc:999");
        buttonNow.putClientProperty(FlatClientProperties.STYLE, "background:if($Calendar.background,$Calendar.background,$Panel.background);"
            + "borderWidth:0;"
            + "focusWidth:0;"
            + "arc:999");
        add(buttonDate);
